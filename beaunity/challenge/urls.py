...
urlpatterns = [
    ...
    path(
        ...
        include(
            [
                path(
                    "", views.ChallengeDetailsView.as_view(), name="challenge-details"
                ),
                path("edit/", views.ChallengeEditView.as_view(), name="challenge-edit"),
                path(
                    "delete/",
                    views.ChallengeDeleteView.as_view(),
                    name="challenge-delete",
                ),
                path("approve/", views.approve_challenge, name="challenge-approve"),
                path(
                    "disapprove/",
                    views.disapprove_challenge,
                    name="challenge-disapprove",
                ),
            ]
        ),
    ),
