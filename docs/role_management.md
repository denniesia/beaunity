...
| Groups          | Event                                                                                                                                                                                                   | Challenge                                                                                                                                                                                                                                     | Post                                                                                                | Category                                                                                     | Comments                                                                                      | Accounts                                                              |
|----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|
...
| User           | Can view events<br/>Can join/leave events<br/>Can like/unlike events<br/>Can add events to Favourites<br/>Can comment on events<br/>                                                                    | Can view challenges<br/>Can add challenges<br/>Can edit own challenges<br/>Can delete own challenges<br/>Can join/leave challenges<br/>Can like/unlike challenges<br/>Can add challenges to Favourites <br/>Can comment on challenges<br/>    | Can view posts<br/>Can like/unlike posts<br/>Can add posts to Favourites<br/>Can comment on posts   | Can view categories                                                                          | Can view comments<br/>Can add comments <br/>Can edit own comments<br/>Can delete own comments | Can view profiles<br/>Can edit own profile<br/>Can delete own profile |
...
- The section *My Events* provides quick overview of the authorised user's own events, with sorting options available for better organization.
